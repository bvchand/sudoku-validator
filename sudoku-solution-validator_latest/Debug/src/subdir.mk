...
src/%.o: ../src/%.c
	...
	gcc -I"/sudoku-solution-validator_v1.3/inc" -I"/Users/bharathi/cpp-workspace/sudoku-solution-validator_latest/inc" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
